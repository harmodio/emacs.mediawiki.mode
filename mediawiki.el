...
(defun mediawiki-uppercase-first(name)
  "Uppercases the first letter of the name, if needed
   added by JGF,6dic14"
  (store-substring name 0 (upcase (aref name 0)))
)
...
(defun mediawiki-open (name)
  ...
  (mediawiki-edit mediawiki-site (mediawiki-uppercase-first name)))
